...
public final class AdjustMashesModelPanel extends JPanel {
	...
	private JSlider genFactorSlider;
	private JSlider cellmaxbatlevelSlider;
	private Font commonFont = new Font("Serif", Font.ITALIC, 15);
	
	public AdjustMashesModelPanel() {
		...
		loadFactorSlider = new JSlider(JSlider.HORIZONTAL, LOAD_FACTOR_MIN, LOAD_FACTOR_MAX, LOAD_FACTOR_INIT);
		...
		genFactorSlider = new JSlider(JSlider.HORIZONTAL, GEN_FACTOR_MIN, GEN_FACTOR_MAX, GEN_FACTOR_INIT);
		...
		cellmaxbatlevelSlider = new JSlider(JSlider.HORIZONTAL, CELL_MAX_BAT_LEVEL_MIN, CELL_MAX_BAT_LEVEL_MAX, CELL_MAX_BAT_LEVEL_INIT);
